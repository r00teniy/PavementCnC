...
namespace PavementCnC.Models
{
    public class AsphaltPavementModel : IPavement
    {
        ...
        public AsphaltPavementModel(PavementType typeOfPavement, string pavementTypeName, string name, PointOfUseType pointOfUse, int acceptedLoad, double pavementArea, bool isInsidePlot = true)
        {
